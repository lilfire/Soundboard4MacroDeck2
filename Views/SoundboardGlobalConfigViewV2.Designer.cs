...
namespace Soundboard4MacroDeck.Views
{
    partial class SoundboardGlobalConfigViewV2
    {
		...
		{
			var resources = new System.ComponentModel.ComponentResourceManager(typeof(SoundboardGlobalConfigViewV2));
			...
			audioFilesTable.CellClick += audioFilesTable_CellClick;
			// 
			// categoryPage
			// 
			...
			categoriesTable.DefaultCellStyle = dataGridViewCellStyle2;
