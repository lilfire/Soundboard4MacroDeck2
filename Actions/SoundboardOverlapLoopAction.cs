...
public sealed class SoundboardOverlapLoopAction : PluginAction
{
    /// <summary>
    /// Name of the action
    /// </summary>
    public override string Name => LocalizationManager.Instance.ActionOverlapLoopSoundName;

    /// <summary>
    /// A short description what this action does
    /// </summary>
    public override string Description => $"{LocalizationManager.Instance.ActionOverlapLoopSoundDescription}.{Environment.NewLine}({LocalizationManager.Instance.ActionSuggestButtonStates})";
    ...
    public override void Trigger(string clientId, ActionButton actionButton)
    {
        ...
        try
        {
            SoundboardPlayer.Execute(SoundboardActions.OverlapLoop, Configuration, actionButton);
        }
        catch (Exception ex)
        {
